...
// //данные товара для бизнес-логики
...
//   getCartTotal(): number;
//   clearCart(): void;
//   checkout(paymentMethod: PaymentMethod, address: string, email: string, phone: string): Promise<boolean>; //Возвращает статус завершения операции
// }

// //данные товара отображаемые на главной странице
...
//   imageUrl: string;
//   price: number;
//   onClick: (productId: string) => void; // Функция для открытия модального окна
// }

// //отображение товара в модальном окне
// export interface ProductDetailsProps {
//   product: Product; // Используем тип Product из бизнес-логики
...
// //данные для модального окна оплаты
// export interface PaymentModalProps {
//   total: number;
//   onClose: () => void;
//   onNext: (paymentMethod: PaymentMethod, address: string) => void; //Переход далее
// }
...
//   onClose: () => void;
//   onSubmit: (email: string, phone: string) => void; // Функция для отправки данных
// }
...
// //Интерфейс для View (компонентов пользовательского интерфейса)
// export interface ProductListView {
//   renderProducts(products: ProductCardProps[]): void;
//   showProductDetails(product: ProductDetailsProps): void;
...
//     show(): void;
//     hide(): void;
//     setModalContent(content: HTMLElement): void;
// }